...
class RecipeDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return matchesAsync.when(
      ...
      error: (_, _) => Scaffold(
        appBar: AppBar(title: Text(l10n.recipesTitle)),
        body: Center(child: Text(l10n.actionFailed)),
      ),
      data: (matches) {
        RecipeMatch? match;
        ...
        // Fall back to unranked recipe from the match list only; offline detail
        // always works when the recipe is still in the ranked set.
        if (match == null) {
          return Scaffold(
            appBar: AppBar(
          ...
          body: ListView(
            ...
            children: [
              Wrap(
                ...
                children: [
                  Chip(
                    label: Text(l10n.recipePrepTime(recipe.prepTimeMinutes)),
                  ),
